...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/ai/deepseek-r1-distill-llama" title="ai/deepseek-r1-distill-llama Docker 镜像中文简介、标签列表与拉取命令">ai/deepseek-r1-distill-llama 中文简介</a>
