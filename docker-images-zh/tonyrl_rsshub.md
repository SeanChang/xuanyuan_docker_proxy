...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/tonyrl/rsshub" title="tonyrl/rsshub Docker 镜像中文简介、标签列表与拉取命令">tonyrl/rsshub 中文简介</a>
...
services:
  rsshub:
    image: docker.xuanyuan.run/diygod/rsshub
    ports:
      - "1200:1200"
    restart: always
    # 可根据需求添加环境变量配置，如：
