...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/ubuntu/prometheus" title="ubuntu/prometheus Docker 镜像中文简介、标签列表与拉取命令">ubuntu/prometheus 中文简介</a>
...
通过以下命令本地启动镜像：  
```sh
docker run -d --name prometheus-container -e TZ=UTC -p 9090:9090 docker.xuanyuan.run/ubuntu/prometheus:2-24.04_stable
```  
