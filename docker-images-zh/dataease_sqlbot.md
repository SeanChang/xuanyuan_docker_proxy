...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/dataease/sqlbot" title="dataease/sqlbot Docker 镜像中文简介、标签列表与拉取命令">dataease/sqlbot 中文简介</a>
...
docker run -d \
  ...
  --privileged=true \
  docker.xuanyuan.run/dataease/sqlbot
```
