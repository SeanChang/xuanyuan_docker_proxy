...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/neo4j" title="library/neo4j Docker 镜像中文简介、标签列表与拉取命令">library/neo4j 中文简介</a>
...
- 开发环境禁用认证：添加`--env=NEO4J_AUTH=none`参数，如：  
  ```console
  docker run --publish=7474:7474 --publish=7687:7687 --volume=$HOME/neo4j/data:/data --env=NEO4J_AUTH=none docker.xuanyuan.run/neo4j
  ```  
