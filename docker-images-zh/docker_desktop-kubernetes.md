...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/docker/desktop-kubernetes" title="docker/desktop-kubernetes Docker 镜像中文简介、标签列表与拉取命令">docker/desktop-kubernetes 中文简介</a>
