...
**轩辕镜像中文简介（在线版）：** [getmeili/meilisearch — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/getmeili/meilisearch)

含镜像标签、拉取命令、部署文档与相关推荐。

[getmeili/meilisearch Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/getmeili/meilisearch)

## 轻量好用的开源搜索引擎：轻松嵌入你的项目  

如果你正在找一款能快速集成、搜索结果精准的工具，这款开源搜索引擎或许正合适。  
