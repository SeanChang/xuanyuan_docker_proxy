...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/apache/iotdb" title="apache/iotdb Docker 镜像中文简介、标签列表与拉取命令">apache/iotdb 中文简介</a>
...
1. **拉取官方镜像**  
   ```shell
   docker pull docker.xuanyuan.run/apache/iotdb:<version>-standalone
   ```
...
3. **启动容器**  
   ...
   docker run -d --name iotdb-service \
                ...
                --network iotdb \
                --ip docker.xuanyuan.run/172.18.0.6 \
                -p 6667:6667 \
...
services:
  iotdb-service:
    image: docker.xuanyuan.run/apache/iotdb:<version>-standalone  # 替换 <version> 为实际版本
    hostname: iotdb-service
