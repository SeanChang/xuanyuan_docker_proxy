---
image: kasmweb/vs-code
description: "适用于Kasm Workspaces的Visual Studio Code浏览器可访问版本，支持独立部署和Web访问。"
source: https://xuanyuan.cloud/zh/r/kasmweb/vs-code
canonical: https://xuanyuan.cloud/zh/r/kasmweb/vs-code
exported_at: 2026-07-12T16:36:12.930Z
---

**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/kasmweb/vs-code" title="kasmweb/vs-code Docker 镜像中文简介、标签列表与拉取命令">kasmweb/vs-code 中文简介</a>
...
<a href="https://app.kasmweb.com/#/cast/6792112908" target="_blank"><img src="https://info.kasmweb.com/hubfs/dockerhub/GIFs/vs-code.gif" width="640" height="360"></a>

**在新浏览器窗口中启动实时演示：** <a href="https://app.kasmweb.com/#/cast/6792112908" target="_blank">实时演示</a>。
...
&lowast;*注意：演示限时3分钟，出于安全考虑，上传/下载功能受限。*
...
我们的Kasm Workspaces团队已开源我们的镜像库（[信息][image_info] 和 [源代码][workspaces_images]）。Web原生渲染由我们的开源项目[KasmVNC][kasmvnc]提供支持。

# 关于本镜像

本镜像包含[Visual Studio Code](https://code.visualstudio.com/)的浏览器可访问版本。

![截图][Image_Screenshot]

[Image_Screenshot]: https://f.hubspotusercontent30.net/hubfs/5856039/dockerhub/image-screenshots/vs-code.png "镜像截图"
...
* Workspaces文档
  ...
  - [Workspaces][installation]：Kasm Workspaces安装和配置指南。
