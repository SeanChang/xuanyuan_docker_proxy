...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/macrosan/uos" title="macrosan/uos Docker 镜像中文简介、标签列表与拉取命令">macrosan/uos 中文简介</a>
...
```console
$ docker pull docker.xuanyuan.run/macrosan/uos:v20-1050
```
...
```dockerfile
# 基于v20-1050版本构建
FROM docker.xuanyuan.run/macrosan/uos:v20-1050
