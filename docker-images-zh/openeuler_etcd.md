...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/openeuler/etcd" title="openeuler/etcd Docker 镜像中文简介、标签列表与拉取命令">openeuler/etcd 中文简介</a>
...
docker run -d --name Etcd-server \
    ...
    docker.xuanyuan.run/openeuler/etcd:latest
```
