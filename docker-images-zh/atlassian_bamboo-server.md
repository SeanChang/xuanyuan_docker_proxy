...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/atlassian/bamboo-server" title="atlassian/bamboo-server Docker 镜像中文简介、标签列表与拉取命令">atlassian/bamboo-server 中文简介</a>
...
services:
  bamboo:
    image: docker.xuanyuan.run/atlassian/bamboo
