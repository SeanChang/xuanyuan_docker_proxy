...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/influxdata/influxdb3-ui" title="influxdata/influxdb3-ui Docker 镜像中文简介、标签列表与拉取命令">influxdata/influxdb3-ui 中文简介</a>
...
```bash
docker pull docker.xuanyuan.run/influxdata/influxdb3-ui:1.0.0
```
...
docker run --detach \
  ...
  --publish 8888:80 \
  docker.xuanyuan.run/influxdata/influxdb3-ui:1.0.0
```
