...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/r-base" title="library/r-base Docker 镜像中文简介、标签列表与拉取命令">library/r-base 中文简介</a>
...
```dockerfile
FROM docker.xuanyuan.run/r-base
