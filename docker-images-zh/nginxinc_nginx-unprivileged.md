...
**轩辕镜像中文简介（在线版）：** [nginxinc/nginx-unprivileged — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/nginxinc/nginx-unprivileged)

含镜像标签、拉取命令、部署文档与相关推荐。

[nginxinc/nginx-unprivileged Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/nginxinc/nginx-unprivileged)
