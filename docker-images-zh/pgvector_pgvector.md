...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/pgvector/pgvector" title="pgvector/pgvector Docker 镜像中文简介、标签列表与拉取命令">pgvector/pgvector 中文简介</a>
...
FROM docker.xuanyuan.run/documents 
