...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/teamspeak" title="library/teamspeak Docker 镜像中文简介、标签列表与拉取命令">library/teamspeak 中文简介</a>
...
services:
  teamspeak:
    image: docker.xuanyuan.run/teamspeak
    restart: always
    ports:
