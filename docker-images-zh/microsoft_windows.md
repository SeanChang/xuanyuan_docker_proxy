...
description: "官方Windows容器基础镜像"
source: https://xuanyuan.cloud/zh/r/microsoft/windows
canonical: https://xuanyuan.cloud/zh/r/microsoft/windows
exported_at: 2026-07-12T16:36:12.930Z
---

**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/microsoft/windows" title="microsoft/windows Docker 镜像中文简介、标签列表与拉取命令">microsoft/windows 中文简介</a>

含镜像标签、拉取命令、部署文档与相关推荐。

# 特色标签

- `LTSC2019` ([LTSC](https://docs.microsoft.com/en-us/windows-server/get-started/servicing-channels-comparison)) `docker pull ***-mcr.xuanyuan.run/windows:ltsc2019`
...
`docker run ***-mcr.xuanyuan.run/windows:ltsc2019`
