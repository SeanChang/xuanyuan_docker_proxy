...
**轩辕镜像中文简介（在线版）：** [xiaoyaliu/alist — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/xiaoyaliu/alist)

含镜像标签、拉取命令、部署文档与相关推荐。

[xiaoyaliu/alist Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/xiaoyaliu/alist)
...
### 详细配置指南  
详细的配置指南请点击查看：[xiaoya-docker 配置指南]([])  
