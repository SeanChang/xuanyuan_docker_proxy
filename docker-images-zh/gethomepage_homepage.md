...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/gethomepage/homepage" title="gethomepage/homepage Docker 镜像中文简介、标签列表与拉取命令">gethomepage/homepage 中文简介</a>
...
services:
  homepage:
    image: ***-ghcr.xuanyuan.run/gethomepage/homepage:latest
...
docker run --name homepage \
  ...
  --restart unless-stopped \
  ***-ghcr.xuanyuan.run/gethomepage/homepage:latest
```  
