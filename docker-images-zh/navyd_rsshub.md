...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/navyd/rsshub" title="navyd/rsshub Docker 镜像中文简介、标签列表与拉取命令">navyd/rsshub 中文简介</a>
...
```docker
docker run -d -p 1200:1200 --name rsshub docker.xuanyuan.run/diygod/rsshub
```
