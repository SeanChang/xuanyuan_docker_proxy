...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/tailscale/tailscale" title="tailscale/tailscale Docker 镜像中文简介、标签列表与拉取命令">tailscale/tailscale 中文简介</a>
...
#### 拉取镜像
```bash
docker pull docker.xuanyuan.run/:stable
```
