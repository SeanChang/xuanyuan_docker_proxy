...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/cimg/python" title="cimg/python Docker 镜像中文简介、标签列表与拉取命令">cimg/python 中文简介</a>
...
docker run -it docker.xuanyuan.run/test/python:3.7.7 bash
```
