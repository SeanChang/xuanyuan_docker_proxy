...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/grafana/grafana-enterprise" title="grafana/grafana-enterprise Docker 镜像中文简介、标签列表与拉取命令">grafana/grafana-enterprise 中文简介</a>
...
```bash
docker run -d --name=grafana -p 3000:3000 docker.xuanyuan.run/grafana/grafana-enterprise
```  
