...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/phitux/dailytxt" title="phitux/dailytxt Docker 镜像中文简介、标签列表与拉取命令">phitux/dailytxt 中文简介</a>
...
services:
  dailytxt:
    ...
    image: docker.xuanyuan.run/phitux/dailytxt:2.x.x
