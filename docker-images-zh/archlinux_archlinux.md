...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/archlinux/archlinux" title="archlinux/archlinux Docker 镜像中文简介、标签列表与拉取命令">archlinux/archlinux 中文简介</a>
...
```sh
docker pull docker.xuanyuan.run/archlinux:latest  # 默认获取 base 版本
docker pull docker.xuanyuan.run/archlinux:base-devel  # 获取 base-devel 版本
```

#### 4.1.2 Arch Linux DockerHub 仓库（每日更新）
```sh
docker pull docker.xuanyuan.run/archlinux/archlinux:latest  # base 版本
docker pull docker.xuanyuan.run/archlinux/archlinux:base-devel  # base-devel 版本
docker pull docker.xuanyuan.run/archlinux/archlinux:multilib-devel  # multilib-devel 版本
```

#### 4.1.3 Quay.io 仓库（每日更新）
```sh
docker pull ***-quay.xuanyuan.run/archlinux/archlinux:latest
```

#### 4.1.4 GitHub Container Registry（每日更新）
```sh
docker pull ***-ghcr.xuanyuan.run/archlinux/archlinux:latest
```
...
docker run -it --rm docker.xuanyuan.run/archlinux:latest /bin/bash
...
docker run -it --rm -v $(pwd):/workspace docker.xuanyuan.run/archlinux/archlinux:base-devel /bin/bash
