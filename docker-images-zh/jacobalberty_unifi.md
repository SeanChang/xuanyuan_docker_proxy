...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/jacobalberty/unifi" title="jacobalberty/unifi Docker 镜像中文简介、标签列表与拉取命令">jacobalberty/unifi 中文简介</a>
...
docker run -d --init \
   ...
   --user unifi \
   --name unifi \
   docker.xuanyuan.run/jacobalberty/unifi
```  
