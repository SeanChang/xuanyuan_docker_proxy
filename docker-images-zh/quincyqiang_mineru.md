...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/quincyqiang/mineru" title="quincyqiang/mineru Docker 镜像中文简介、标签列表与拉取命令">quincyqiang/mineru 中文简介</a>
...
```bash
docker run -itd --name=mineru_server --gpus=all -p 8888:8000 docker.xuanyuan.run/quincyqiang/mineru:0.1-models
```
...
*   **Docker Hub 地址**：
    ```bash
    docker pull docker.xuanyuan.run/quincyqiang/mineru:0.1-models
    ```
