...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/amd64/openjdk" title="amd64/openjdk Docker 镜像中文简介、标签列表与拉取命令">amd64/openjdk 中文简介</a>
...
```dockerfile
FROM docker.xuanyuan.run/amd64/openjdk:11
COPY . /usr/src/myapp
