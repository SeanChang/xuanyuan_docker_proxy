...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/apache/spark" title="apache/spark Docker 镜像中文简介、标签列表与拉取命令">apache/spark 中文简介</a>
...
```bash
docker run -it docker.xuanyuan.run/apache/spark /opt/spark/bin/spark-shell
```
