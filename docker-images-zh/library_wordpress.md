...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/wordpress" title="library/wordpress Docker 镜像中文简介、标签列表与拉取命令">library/wordpress 中文简介</a>
...
services:
  wordpress:
    image: docker.xuanyuan.run/wordpress
    restart: always
    ports:
      - 8080:80
    environment:
