...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/kvaps/mjpg-streamer" title="kvaps/mjpg-streamer Docker 镜像中文简介、标签列表与拉取命令">kvaps/mjpg-streamer 中文简介</a>
...
mjpg-streamer:
  ...
  image: docker.xuanyuan.run/kvaps/mjpg-streamer  # 使用的Docker镜像
  devices:
