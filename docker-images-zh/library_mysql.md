...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/mysql" title="library/mysql Docker 镜像中文简介、标签列表与拉取命令">library/mysql 中文简介</a>
...
- 架构随 tag 而异；MySQL 5.7 等旧版 tag 可能仅 amd64，请以标签页「系统架构」列为准（https://xuanyuan.cloud/r/library/mysql/tags）
...
docker run -d \
  ...
  -p 3306:3306 \
  docker.xuanyuan.run/mysql:latest
```
