---
image: hanxi/cups-web
description: "CUPS Web是一个功能完善的网页版打印机管理工具，支持远程打印、多用户管理和打印记录追踪，轻松实现家庭或小型办公室的打印管理需求。"
source: https://xuanyuan.cloud/zh/r/hanxi/cups-web
canonical: https://xuanyuan.cloud/zh/r/hanxi/cups-web
exported_at: 2026-07-12T16:36:12.930Z
---

**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/hanxi/cups-web" title="hanxi/cups-web Docker 镜像中文简介、标签列表与拉取命令">hanxi/cups-web 中文简介</a>
