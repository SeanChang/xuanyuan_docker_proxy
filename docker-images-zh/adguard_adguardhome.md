...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/adguard/adguardhome" title="adguard/adguardhome Docker 镜像中文简介、标签列表与拉取命令">adguard/adguardhome 中文简介</a>
...
执行以下命令拉取最新稳定版镜像：
```sh
docker pull docker.xuanyuan.run/adguard/adguardhome
```
...
docker run --name adguardhome \
    ...
    -d docker.xuanyuan.run/adguard/adguardhome
```
...
```sh
docker pull docker.xuanyuan.run/adguard/adguardhome:edge
```
