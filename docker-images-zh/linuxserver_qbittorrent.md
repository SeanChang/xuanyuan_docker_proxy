...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/linuxserver/qbittorrent" title="linuxserver/qbittorrent Docker 镜像中文简介、标签列表与拉取命令">linuxserver/qbittorrent 中文简介</a>
...
services:
  qbittorrent:
    image: docker.xuanyuan.run/linuxserver/qbittorrent:latest
