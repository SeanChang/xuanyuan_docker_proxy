...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/outlovecn/portainer-cn" title="outlovecn/portainer-cn Docker 镜像中文简介、标签列表与拉取命令">outlovecn/portainer-cn 中文简介</a>
...
services:
  portainer:
    image: docker.xuanyuan.run/outlovecn/portainer-cn:latest  # 使用中文镜像
...
### 操作命令：  
```bash
docker pull docker.xuanyuan.run/outlovecn/portainer-cn
```  
