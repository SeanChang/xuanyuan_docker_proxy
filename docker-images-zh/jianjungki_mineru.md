...
**轩辕镜像中文简介（在线版）：** [jianjungki/mineru — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/jianjungki/mineru)

含镜像标签、拉取命令、部署文档与相关推荐。

[jianjungki/mineru Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/jianjungki/mineru)
...
# 启动容器
docker run -p 8001:8001 --env-file .env mineru:latest
```
- 参数说明：
...
services:
  mineru:
    image: jianjungki/mineru:latest
    ports:
