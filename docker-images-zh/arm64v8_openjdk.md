...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/arm64v8/openjdk" title="arm64v8/openjdk Docker 镜像中文简介、标签列表与拉取命令">arm64v8/openjdk 中文简介</a>
...
```dockerfile
FROM docker.xuanyuan.run/arm64v8/openjdk:11
COPY . /usr/src/myapp
