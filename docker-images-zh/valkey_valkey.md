...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/valkey/valkey" title="valkey/valkey Docker 镜像中文简介、标签列表与拉取命令">valkey/valkey 中文简介</a>
...
```dockerfile
FROM docker.xuanyuan.run/valkey/valkey
