...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/alpine" title="library/alpine Docker 镜像中文简介、标签列表与拉取命令">library/alpine 中文简介</a>
...
```dockerfile
FROM docker.xuanyuan.run/alpine:3.14
