...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/alpine/socat" title="alpine/socat Docker 镜像中文简介、标签列表与拉取命令">alpine/socat 中文简介</a>
...
```bash
$ docker pull docker.xuanyuan.run/alpine/socat
...
services:
  cockpit-relay:
    image: docker.xuanyuan.run/alpine/socat
