...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/ubuntu/squid" title="ubuntu/squid Docker 镜像中文简介、标签列表与拉取命令">ubuntu/squid 中文简介</a>
...
```sh
docker run -d --name squid-container -e TZ=UTC -p 3128:3128 docker.xuanyuan.run/ubuntu/squid:5.2-22.04_beta
```  
