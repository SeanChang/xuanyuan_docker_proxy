...
**轩辕镜像中文简介（在线版）：** [jaegertracing/jaeger-es-index-cleaner — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/jaegertracing/jaeger-es-index-cleaner)

含镜像标签、拉取命令、部署文档与相关推荐。

[jaegertracing/jaeger-es-index-cleaner Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/jaegertracing/jaeger-es-index-cleaner)
