...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/keking/kkfileview" title="keking/kkfileview Docker 镜像中文简介、标签列表与拉取命令">keking/kkfileview 中文简介</a>
...
```bash
docker run -d -p 8012:8012 --name kkfileview docker.xuanyuan.run/keking/kkfileview:latest
```
...
services:
  kkfileview:
    image: docker.xuanyuan.run/keking/kkfileview:latest
    ports:
      - "8012:8012"
    restart: always
