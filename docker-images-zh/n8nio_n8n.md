...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/n8nio/n8n" title="n8nio/n8n Docker 镜像中文简介、标签列表与拉取命令">n8nio/n8n 中文简介</a>
...
docker run -it --rm \
 ...
 -e DB_POSTGRESDB_SCHEMA=< docker.xuanyuan.run/schema > \
