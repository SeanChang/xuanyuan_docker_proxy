...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/influxdb" title="library/influxdb Docker 镜像中文简介、标签列表与拉取命令">library/influxdb 中文简介</a>
...
services:
  influxdb3-core:
    ...
    image: docker.xuanyuan.run/influxdb:3-core
    ports:
...
查看所有服务器参数：  
```bash
docker run --rm docker.xuanyuan.run/influxdb:3-core influxdb3 serve --help
```  
