...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/tdengine/tdengine" title="tdengine/tdengine Docker 镜像中文简介、标签列表与拉取命令">tdengine/tdengine 中文简介</a>
...
docker run -d \
  ...
  docker.xuanyuan.run/tdengine/tdengine
```
...
docker run -d \
  ...
  -p 6030-6060:6030-6060 \
  -p 6030-6060:6030-6060/udp \
  docker.xuanyuan.run/tdengine/tdengine:2.4.0.0
```
