...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/kafbat/kafka-ui" title="kafbat/kafka-ui Docker 镜像中文简介、标签列表与拉取命令">kafbat/kafka-ui 中文简介</a>
...
```bash
docker run -it -p 8080:8080 -e DYNAMIC_CONFIG_ENABLED=true ***-ghcr.xuanyuan.run/kafbat/kafka-ui
```
...
services:
  kafbat-ui:
    ...
    image: ***-ghcr.xuanyuan.run/kafbat/kafka-ui:latest
    ports:
