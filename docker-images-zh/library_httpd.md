...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/httpd" title="library/httpd Docker 镜像中文简介、标签列表与拉取命令">library/httpd 中文简介</a>
...
#### 1. 在项目中创建Dockerfile  
```dockerfile
FROM docker.xuanyuan.run/httpd:2.4
