...
**轩辕镜像中文简介（在线版）：** [iotechsys/opc-ua-sim — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/iotechsys/opc-ua-sim)

含镜像标签、拉取命令、部署文档与相关推荐。

[iotechsys/opc-ua-sim Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/iotechsys/opc-ua-sim)
...
```docker
docker run -d -p 4840:4840 --name opc-ua-simulator opc-ua-simulator:latest
```
