...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/openeuler/milvus" title="openeuler/milvus Docker 镜像中文简介、标签列表与拉取命令">openeuler/milvus 中文简介</a>
...
```bash
docker run --name euler-milvus -it docker.xuanyuan.run/openeuler/milvus:latest
```
