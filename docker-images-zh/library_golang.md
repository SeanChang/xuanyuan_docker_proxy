...
**轩辕镜像中文简介（在线版）：** <a href="https://xuanyuan.cloud/zh/r/library/golang" title="library/golang Docker 镜像中文简介、标签列表与拉取命令">library/golang 中文简介</a>
...
```dockerfile
FROM docker.xuanyuan.run/golang:1.25  
WORKDIR /usr/src/app  
