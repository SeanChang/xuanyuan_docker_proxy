...
```bash
$ docker pull docker.xuanyuan.run/tenable/nessus:<version-OS>
```
...
**示例**：
- 拉取Ubuntu系统的Nessus 10.6.0版本：`docker pull docker.xuanyuan.run/tenable/nessus:10.6.0-ubuntu`
- 拉取Oracle Linux系统的最新Nessus版本：`docker pull docker.xuanyuan.run/tenable/nessus:latest-oracle`
