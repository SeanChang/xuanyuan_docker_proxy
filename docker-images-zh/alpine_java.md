...
**轩辕镜像中文简介（在线版）：** [alpine/java — 轩辕镜像中文简介](https://xuanyuan.cloud/zh/r/alpine/java)

含镜像标签、拉取命令、部署文档与相关推荐。

[alpine/java Docker 镜像中文简介、标签列表与拉取命令](https://xuanyuan.cloud/zh/r/alpine/java)

# Java容器构建脚本仓库  


## 仓库用途  
本仓库包含用于生成官方 eclipse-temurin Java 容器的构建脚本。  


## Dockerfile 使用说明  
仓库内的 Dockerfile 供 [adoptium/containers]([]) 仓库调用，用于构建 Java 容器。  


## 平台支持  
当前仅支持 `linux/amd64` 平台。  
