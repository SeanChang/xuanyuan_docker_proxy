...
登录网站后，在左侧菜单栏的「专属域名」菜单中获取您的专属域名，格式为：`xxx.xuanyuan.run`

> **注意**：请将 **xxx.xuanyuan.run** 替换为您的专属域名。[登录](https://xuanyuan.cloud/)网站后，点击左侧菜单栏的「专属域名」菜单即可获取。
...
> **注意**：此配置文件将设置 OrbStack 的镜像源

> **重要**：请将 **xxx.xuanyuan.run** 替换为您的专属域名。[登录](https://xuanyuan.cloud/)网站后，点击左侧菜单栏的「专属域名」菜单即可获取。
