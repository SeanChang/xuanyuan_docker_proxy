...
- [1. 适用场景](#1-适用场景)
- [2. 安装 Dev Containers CLI](#2-安装-dev-containers-cli)
- [3. 准备工作空间](#3-准备工作空间)
- [4. 配置 devcontainer.json](#4-配置-devcontainerjson)
- [5. 启动 Dev Container](#5-启动-dev-container)
- [6. 测试 Feature 是否安装成功](#6-测试-feature-是否安装成功)
- [7. 高级用法：添加多个 Feature](#7-高级用法添加多个-feature)
- [8. 小贴士](#8-小贴士)
- [9. 常见问题](#9-常见问题)
