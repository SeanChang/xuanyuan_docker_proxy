...
![一台打印机全办公室共用：5 分钟 Docker 一键部署 CUPS](https://imgs.xuanyuan.cloud/docker/blog/cups.png)
...
![OpenPrinting CUPS 2.4.10 首页：导航含 Home / Administration / Printers](https://imgs.xuanyuan.cloud/docker/blog/cups-1.png)

点顶部 **Administration**，浏览器会弹出登录框：

![CUPS 登录框：地址 192.168.1.18:631，用户名 admin](https://imgs.xuanyuan.cloud/docker/blog/cups-2.png)
...
![Administration 管理页：Add Printer 与服务器共享选项](https://imgs.xuanyuan.cloud/docker/blog/cups-3.png)
...
![添加打印机：选择 Internet Printing Protocol (ipp)](https://imgs.xuanyuan.cloud/docker/blog/cups-4.png)
...
![添加打印机：Connection 填入 ipp://192.168.1.20/ipp/print](https://imgs.xuanyuan.cloud/docker/blog/cups-5.png)
...
![命名打印机 HP-Home 并勾选 Share This Printer](https://imgs.xuanyuan.cloud/docker/blog/cups-6.png)

### 9.4 选择厂商与驱动

**Make** 列表中选择 **HP**，点 **Continue**。

![选择厂商 Make：HP](https://imgs.xuanyuan.cloud/docker/blog/cups-7.png)

**Model** 列表中选择 **IPP Everywhere™**（列表顶部），然后点 **Add Printer**。

![选择驱动 Model：IPP Everywhere™](https://imgs.xuanyuan.cloud/docker/blog/cups-8.png)
...
![设置默认选项：Media Size 为 A4](https://imgs.xuanyuan.cloud/docker/blog/cups-9.png)

### 9.6 确认添加成功

顶部点 **Printers**，进入打印机详情。状态应为：**Idle, Accepting Jobs, Shared**；驱动为 **IPP Everywhere (color)**；连接为 `ipp://192.168.1.20/ipp/print`。

![打印机 HP-Home 状态 Idle，连接 ipp://192.168.1.20/ipp/print](https://imgs.xuanyuan.cloud/docker/blog/cups-10.png)
...
![Maintenance 菜单：选择 Print Test Page](https://imgs.xuanyuan.cloud/docker/blog/cups-11.png)
...
![打印测试页成功：job ID 为 HP-Home-1](https://imgs.xuanyuan.cloud/docker/blog/cups-12.png)

返回打印机页可见任务状态变为 **Processing**，Jobs 列表中 `HP-Home-1` 显示 `Rendering completed`：

![作业 HP-Home-1 处理中，Rendering completed](https://imgs.xuanyuan.cloud/docker/blog/cups-13.png)

打印机吐出 CUPS 测试页（含 CMYK / RGB 色块、Job ID、`ippeve.ppd` 驱动信息等），则部署路径闭环成功。

![物理测试页：Printer test page，Job ID HP-Home-1，Driver ippeve.ppd](https://imgs.xuanyuan.cloud/docker/blog/cups-14.png)
