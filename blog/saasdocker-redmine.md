...
![团队工单不想上 SaaS？Docker 跑个 Redmine，浏览器就能管项目](https://imgs.xuanyuan.cloud/docker/blog/redmine.png)
...
![Redmine 首页：Welcome to Redmine 欢迎语，右上角登录与注册入口](https://imgs.xuanyuan.cloud/docker/blog/redmine-1.png)
...
![Redmine 登录页：登录名 admin，输入默认密码后点击登录](https://imgs.xuanyuan.cloud/docker/blog/redmine-2.png)
...
![Redmine 修改密码页：当前密码、新密码与确认，至少 8 个字符](https://imgs.xuanyuan.cloud/docker/blog/redmine-3.png)
...
![Redmine 我的帐号：密码更新成功提示，语言与通知偏好设置](https://imgs.xuanyuan.cloud/docker/blog/redmine-4.png)
...
![Redmine 管理页：载入默认配置提示，语言选简体中文](https://imgs.xuanyuan.cloud/docker/blog/redmine-7.png)
...
![Redmine 新建项目：名称、标识 app、模块勾选问题跟踪与甘特图等](https://imgs.xuanyuan.cloud/docker/blog/redmine-5.png)
...
![Redmine 我的工作台：指派与已报告问题面板，新增区块下拉菜单](https://imgs.xuanyuan.cloud/docker/blog/redmine-6.png)
