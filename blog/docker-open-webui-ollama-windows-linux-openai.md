...
![Docker 部署 Open WebUI + Ollama 完整教程（Windows / Linux 通用）—— 打造自己的本地OpenAI](https://imgs.xuanyuan.cloud/docker/blog/docker-open-webui-ollama-1.png)
...
![Ollama 与 Open WebUI 是什么](https://imgs.xuanyuan.cloud/docker/blog/docker-open-webui-ollama.png)
...
![创建一个管理员账号](https://imgs.xuanyuan.cloud/docker/blog/docker-open-webui-ollama-2.png)

首次访问时，需要创建一个管理员账号（设置用户名、密码），创建完成后登录，就能进入 Open WebUI 的主界面。

![Qwen 0\.5B 模型](https://imgs.xuanyuan.cloud/docker/blog/docker-open-webui-ollama-5.png)

登录后，点击界面中的“模型”选项，就能看到我们刚才下载的 Qwen 0\.5B 模型，选择模型后，就可以开始聊天交互了，和使用 ChatGPT 等工具的体验完全一致。

![始聊天交互](https://imgs.xuanyuan.cloud/docker/blog/docker-open-webui-ollama-6.png)
