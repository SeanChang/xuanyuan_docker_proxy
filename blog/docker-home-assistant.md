...
![Home Assistant Docker 部署教程：打造本地智能家居平台，手把手教你实战搭建](https://imgs.xuanyuan.cloud/docker/blog/docker-home-assistant.png)
...
![Home Assistant 欢迎页：创建我的智能家居、上传备份、Home Assistant Cloud 还原选项](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-1.png)
...
![创建用户：填写姓名、用户名、密码与确认密码](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-2.png)
...
![家的位置：搜索杭州并在地图上确认坐标](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-3.png)
...
![帮助我们帮助你：基础分析、使用情况、统计数据、诊断信息开关](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-4.png)
...
![我们发现了兼容的设备：Internet Printing Protocol IPP 集成](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-5.png)
...
![概览仪表盘：欢迎 Sean Chang、区域卡片、天气 33.5°C 阴](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-6.png)
...
![地图页：杭州市位置标记与 OpenStreetMap 底图](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-7.png)
...
![能源配置向导第 1 步：电力公司与电网连接](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-8.png)
...
![活动日志：Home Assistant started、Sun 白天/夜间切换事件](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-9.png)
...
![媒体源：AI 图片、Camera、Radio Browser、Text-to-speech 等](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-10.png)
...
![待办事项清单：购物清单为空，可添加项目](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-11.png)
...
![设置页：Home Assistant Cloud、设备与服务、自动化与场景、系统等](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-12.png)
...
![您想要添加什么：已发现 HP Smart Tank 210-220 series IPP 打印机](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-13.png)
...
![已发现的打印机：确认设置 HP Smart Tank 210-220 series](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-14.png)
...
![命名和分配：设备名称与区域选择客厅](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-15.png)
...
![客厅区域：HP Smart Tank 墨盒余量与空闲状态](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-16.png)
...
![设备信息：HP Smart Tank 固件、序列号、IPP 集成与传感器](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-17.png)
...
![添加 HP Smart Tank 至自动化或脚本：创建触发器、条件、动作](https://imgs.xuanyuan.cloud/docker/blog/homeassistant-18.png)
