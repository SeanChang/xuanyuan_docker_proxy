...
![Docker 部署 FalkorDB：轻松搭建属性图数据库与知识图谱平台](https://imgs.xuanyuan.cloud/docker/blog/falkordb.webp)
...
![FalkorDB Browser 登录页：Manual Configuration，Host 为 localhost、Port 6379](https://imgs.xuanyuan.cloud/docker/blog/falkordb-1.webp)

### 6.2 欢迎向导

顶栏应显示 **FalkorDB: v4.20.1**（或相近）与 **`localhost:6379`**。首次可弹出 Welcome 教程，**Next** 跟做或 **Skip Tutorial** 跳过。

![FalkorDB Browser 欢迎向导：可 Skip Tutorial 或 Next](https://imgs.xuanyuan.cloud/docker/blog/falkordb-2.webp)

### 6.3 创建图

左侧 **Select Graph** 旁点 **+**，图名填 **`MotoGP`**，点 **Create your Graph**。

![FalkorDB Browser 创建新图：图名为 MotoGP](https://imgs.xuanyuan.cloud/docker/blog/falkordb-3.webp)
...
![FalkorDB Browser：CREATE 写入骑手与车队关系](https://imgs.xuanyuan.cloud/docker/blog/falkordb-4.webp)
...
![FalkorDB Browser：MATCH Rider 显示三个骑手节点](https://imgs.xuanyuan.cloud/docker/blog/falkordb-5.webp)
...
![FalkorDB Browser：MATCH Team 显示 Yamaha、Honda、Ducati](https://imgs.xuanyuan.cloud/docker/blog/falkordb-6.webp)
...
![FalkorDB Browser：MATCH rides 路径展示骑手到车队](https://imgs.xuanyuan.cloud/docker/blog/falkordb-7.webp)
...
![FalkorDB Browser：UNION 查询返回带 name 的节点与关系](https://imgs.xuanyuan.cloud/docker/blog/falkordb-8.webp)
...
![FalkorDB Browser：UDF Libraries](https://imgs.xuanyuan.cloud/docker/blog/falkordb-9.webp)

![FalkorDB Browser Settings 页](https://imgs.xuanyuan.cloud/docker/blog/falkordb-10.webp)

![FalkorDB Browser Users：default 为 Admin](https://imgs.xuanyuan.cloud/docker/blog/falkordb-11.webp)
