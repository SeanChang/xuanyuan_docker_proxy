...
![Linux 服务器没桌面？Docker 跑个 Webtop，浏览器里就是图形桌面](https://imgs.xuanyuan.cloud/docker/blog/webtop.png)
...
![浏览器中的 XFCE 桌面](https://imgs.xuanyuan.cloud/docker/blog/webtop-3.png)
...
![HTTPS 登录框](https://imgs.xuanyuan.cloud/docker/blog/webtop-1.png)
...
![文件管理器与磁盘属性](https://imgs.xuanyuan.cloud/docker/blog/webtop-4.png)
...
![终端执行 uname -a](https://imgs.xuanyuan.cloud/docker/blog/webtop-5.png)
...
![应用程序菜单与设置子菜单](https://imgs.xuanyuan.cloud/docker/blog/webtop-6.png)
...
![桌面内浏览器访问轩辕镜像](https://imgs.xuanyuan.cloud/docker/blog/webtop-7.png)
...
![应用程序查找器](https://imgs.xuanyuan.cloud/docker/blog/webtop-8.png)
...
![AVX2 不支持报错](https://imgs.xuanyuan.cloud/docker/blog/webtop-2.png)
