...
![KUBOARD Docker 容器化部署指南](https://imgs.xuanyuan.cloud/docker/blog/docker-kuboard.png)
...
**关键要点**：
- 使用一键脚本`bash <(wget -qO- https://get.xuanyuan.cloud/docker.sh)`快速部署Docker环境，自动配置轩辕镜像访问支持
