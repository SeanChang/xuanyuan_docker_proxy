...
![服务器没有桌面？Docker 跑个 Chrome，浏览器就能远程用](https://imgs.xuanyuan.cloud/docker/blog/docker-linuxserver-chrome.png)
...
![通过轩辕镜像拉取chrome镜像](https://imgs.xuanyuan.cloud/docker/blog/docker-linuxserver-chrome-4.png)
...
![浏览器访问远程 Chrome 桌面，登录界面](https://imgs.xuanyuan.cloud/docker/blog/docker-linuxserver-chrome-1.png)

![浏览器访问远程 Chrome 桌面，浏览器打开界面](https://imgs.xuanyuan.cloud/docker/blog/docker-linuxserver-chrome-2.png)

![浏览器访问远程 Chrome 桌面，搜索结果界面](https://imgs.xuanyuan.cloud/docker/blog/docker-linuxserver-chrome-3.png)
