...
![轻量AI接口网关一键部署｜calciumion/new-api Windows/Linux Docker 部署全教程](https://imgs.xuanyuan.cloud/docker/blog/docker-newapi.png)
...
![new-api 设置](https://imgs.xuanyuan.cloud/docker/blog/docker-newapi-1.png)
...
![new-api 设置密码](https://imgs.xuanyuan.cloud/docker/blog/docker-newapi-2.png)

建议第一时间修改密码，提升服务安全性。

![new-api 选择模式](https://imgs.xuanyuan.cloud/docker/blog/docker-newapi-3.png)

![new-api 完成设置](https://imgs.xuanyuan.cloud/docker/blog/docker-newapi-4.png)

![new-api 首页](https://imgs.xuanyuan.cloud/docker/blog/docker-newapi-5.png)
