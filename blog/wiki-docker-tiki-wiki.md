...
![想自建 Wiki 与知识库？Docker 部署 Tiki Wiki，浏览器就能协作](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki.png)
...
![Tiki 安装向导 Security Precaution 页：填写数据库用户名 tiki 与密码](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-1.png)
...
![Tiki Installer 27.5 Welcome 页，默认语言 English](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-2.png)

*图 2：Welcome 页，可选择安装语言*

在 **Select your language** 下拉框中选择 **Simplified Chinese（简体中文, cn）**：

![选择简体中文作为安装语言](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-3.png)
...
![License 许可协议页](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-4.png)
...
![系统要求检测：Memory 128 MB 通过](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-5.png)
...
![数据库连接成功：Tiki found an existing database connection，Database name tikiwiki](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-6.png)
...
![选择 InnoDB 引擎并点击安装](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-7.png)

*图 7：确认 InnoDB 后点击「安装」*

安装过程会创建数据表，进度条从 0% 逐步增加（约 945 条 SQL，需等待 1～3 分钟）：

![Database Installation 进度：Table creation status 10%](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-8.png)
...
![Installation complete：admin 用户临时密码 admin，945 SQL queries 成功](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-9.png)
...
![一般设置：Server domain 留空，浏览器标题 My Tiki](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-10.png)
...
![Last Notes 最后说明页](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-11.png)
...
![Enter Your Tiki：Ready to run，推荐 Enter Tiki and Lock Installer](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-12.png)
...
![Set password：admin 用户须设置新密码与邮箱](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-13.png)
...
![Tiki Setup 引导页：Congratulations，working instance of Tiki 27.5](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-14.png)
...
![Featured Site Configurations：Collaborative Community 与 Company Intranet](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-15.png)
...
![管理后台 Profiles 页：Preference Filters 与模块图标网格](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-16.png)
...
![Apply the profile Company_Intranet_21 确认对话框](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-17.png)
...
![公司内网首页 Our Intranet：Profile applied successfully](https://imgs.xuanyuan.cloud/docker/blog/tikiwiki-18.png)
