...
![10 分钟上手 OpenCode：Docker 一键部署，浏览器里用 AI 写代码](https://imgs.xuanyuan.cloud/docker/blog/opencode.png)
...
![OpenCode 登录认证](https://imgs.xuanyuan.cloud/docker/blog/opencode-1.png)

*图 1：首次访问需输入 HTTP 基础认证的用户名与密码*

登录成功后进入 OpenCode 控制台。若首页显示「未找到会话」，说明尚未打开项目或创建会话，属于正常现象。

![OpenCode 控制台首页](https://imgs.xuanyuan.cloud/docker/blog/opencode-2.png)
...
![打开项目对话框](https://imgs.xuanyuan.cloud/docker/blog/opencode-3.png)
...
![选择 AI 模型](https://imgs.xuanyuan.cloud/docker/blog/opencode-7.png)

*图 4：OpenCode 内置多款免费模型，新手可先选 Big Pickle 或 MiMo V2.5*

![新建会话界面](https://imgs.xuanyuan.cloud/docker/blog/opencode-5.png)
...
![输入 AI 需求](https://imgs.xuanyuan.cloud/docker/blog/opencode-6.png)

*图 6：用自然语言描述需求，OpenCode 自动创建并写入文件*

![AI 写入代码](https://imgs.xuanyuan.cloud/docker/blog/opencode-8.png)

*图 7：AI 执行「写入 index.html」，右侧审查面板展示变更*

稍等片刻，AI 会提示生成完成：`index.html 是一个全屏居中展示 "hello-world" 大字效果的简单个人主页。`

![生成完成](https://imgs.xuanyuan.cloud/docker/blog/opencode-9.png)
...
![hello-world 预览效果](https://imgs.xuanyuan.cloud/docker/blog/opencode-10.png)
