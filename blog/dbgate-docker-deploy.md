...
![Docker 部署 DbGate：一站式管理 MySQL、PostgreSQL、SQLite 等数据库](https://img.xuanyuan.dev/docker/blog/dbgate.webp)
...
![DbGate 新建连接：展开 Connection Type，选择 MySQL / PostgreSQL / MongoDB 等引擎](https://img.xuanyuan.dev/docker/blog/dbgate-1.webp)
...
![DbGate 配置 MySQL：Server 填 dockerhost、端口 3306，界面提示 Docker 下勿用 localhost](https://img.xuanyuan.dev/docker/blog/dbgate-2.webp)
