...
![告别命令行！Docker 部署 phpMyAdmin，轻松管理 MySQL](https://imgs.xuanyuan.cloud/docker/blog/phpmyadmin.webp)
...
![phpMyAdmin 登录页：语言选中文简体，用户名 root，输入密码后点登录](https://imgs.xuanyuan.cloud/docker/blog/phpmyadmin-1.webp)
...
![phpMyAdmin 首页：左侧库列表，右侧显示 MariaDB 与 Apache/PHP 信息](https://imgs.xuanyuan.cloud/docker/blog/phpmyadmin-2.webp)
...
![phpMyAdmin 结构页：展开 mysql 库表列表，底部可新建数据表](https://imgs.xuanyuan.cloud/docker/blog/phpmyadmin-3.webp)
...
![phpMyAdmin 会话错误：Permission denied，session 路径 /sessions](https://imgs.xuanyuan.cloud/docker/blog/phpmyadmin-error-1.webp)
