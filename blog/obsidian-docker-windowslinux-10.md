...
![Obsidian Docker 部署｜Windows+Linux 通用，新手也能10分钟上手](https://imgs.xuanyuan.cloud/docker/blog/docker-obsidian-2.png)
...
![Obsidian 中文主界面：欢迎笔记与关系图谱](https://imgs.xuanyuan.cloud/docker/blog/obsidian-3.webp)
...
![浏览器提示 192.168.1.10:3001 连接不安全并显示剪贴板权限](https://imgs.xuanyuan.cloud/docker/blog/obsidian-9.webp)
...
![Obsidian 欢迎页英文：Version 1.13.4 与 Quick start](https://imgs.xuanyuan.cloud/docker/blog/obsidian-1.webp)

*图 3：首次欢迎页（英文），版本 1.13.4*

![Obsidian 欢迎页已切换简体中文](https://imgs.xuanyuan.cloud/docker/blog/obsidian-2.webp)

*图 4：切换为「简体中文」后的欢迎页*

建库完成后：左侧文件列表、中间「欢迎」笔记、右侧「关系图谱」：

![Obsidian 欢迎笔记与关系图谱中文主界面](https://imgs.xuanyuan.cloud/docker/blog/obsidian-3.webp)
...
![Obsidian 双栏关系图谱视图](https://imgs.xuanyuan.cloud/docker/blog/obsidian-4.webp)
...
![Obsidian Canvas 画布与右侧关系图谱](https://imgs.xuanyuan.cloud/docker/blog/obsidian-5.webp)
...
![Obsidian 日记笔记 2026-08-07 与关系图谱](https://imgs.xuanyuan.cloud/docker/blog/obsidian-6.webp)
...
![Obsidian 命令面板选择命令](https://imgs.xuanyuan.cloud/docker/blog/obsidian-7.webp)
...
![Obsidian 表格列出仓库文件并与图谱对照](https://imgs.xuanyuan.cloud/docker/blog/obsidian-8.webp)
...
![Obsidian 搜索选项语法说明](https://imgs.xuanyuan.cloud/docker/blog/obsidian-10.webp)
...
![Selkies 侧边栏统计信息 CPU 内存 FPS](https://imgs.xuanyuan.cloud/docker/blog/obsidian-11.webp)
...
![Selkies 屏幕设置 HiDPI 与 150% 缩放](https://imgs.xuanyuan.cloud/docker/blog/obsidian-12.webp)
...
![Selkies 视频设置 x264enc 与帧率](https://imgs.xuanyuan.cloud/docker/blog/obsidian-13.webp)
...
![Selkies 剪贴板文件传输与共享链接](https://imgs.xuanyuan.cloud/docker/blog/obsidian-14.webp)
