...
![10 分钟上手 Stirling PDF：Docker 一键部署，浏览器里合并压缩加水印](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf.png)
...
![Stirling PDF V2 欢迎页：欢迎使用 Stirling V2 引导弹窗](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf-1.png)
...
![打开 PDF 后的 Stirling PDF 主界面：查看器与右侧工具栏](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf-2.png)
...
![PDF 文本编辑器欢迎说明：抢先体验与适用场景](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf-3.png)

*图 3：文本编辑器说明弹窗，建议先阅读适用场景与限制*

点击 **「知道了」** 进入编辑模式，可直接选中页面文字并修改：

![PDF 文本编辑器修改文字：在页面上直接编辑正文](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf-4.png)
...
![添加水印配置界面：措辞填入 URL 或文字](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf-5.png)

*图 5：水印配置步骤，措辞中可填文字或链接*

预览满意后，在 **「审核」** 步骤点击 **「下载」**，保存带水印的 PDF：

![水印效果预览与下载：页面铺满水印并可下载](https://imgs.xuanyuan.cloud/docker/blog/stirling-pdf-6.png)
