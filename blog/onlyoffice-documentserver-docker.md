...
![onlyoffice Ubuntu Docker 容器化部署指南](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice.png)
...
![ONLYOFFICE 欢迎页：Community Edition 安装成功，含 JWT 说明](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-1.png)
...
![欢迎页 Testing before integration 与 GO TO TEST EXAMPLE](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-2.png)
...
![languages.forEach is not a function 报错页](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-3.png)
...
![example 列表页 Welcome to ONLYOFFICE Docs](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-4.png)
...
![上传 docx 转换成功，可 EDIT / VIEW](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-5.png)

上传成功后，example 首页会切换到 **Your documents** 文档列表，已传文件出现在表格中，可对每个文件进行编辑、预览或删除：

![example Your documents 文档列表](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-7.png)

点击 **EDIT** 进入 Word 在线编辑器，文档内容正常加载，可修改文字、使用左侧评论/聊天等协作功能（界面为深色主题）：

![Word 在线编辑：测试报告 docx 正常打开](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-6.png)

除 docx 外，**Presentation** 同样可在线编辑。新建或上传 `.pptx` 后，幻灯片、表格等内容在浏览器中正常渲染：

![Presentation 在线编辑：工作汇报 pptx](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-8.png)
...
![一键转换文档格式：docx 转 TXT / PDF 等](https://imgs.xuanyuan.cloud/docker/blog/onlyoffice-9.png)
