...
![Docker 部署 Rocket.Chat：轻松搭建私有化团队聊天与协作平台](https://imgs.xuanyuan.cloud/docker/blog/rocketchat.webp)
...
![Rocket.Chat 首次安装：管理员信息](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-1.webp)
...
![Rocket.Chat 向导：填写管理员姓名用户名邮箱密码](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-1.webp)
...
![Rocket.Chat 向导：组织信息](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-2.webp)
...
![Rocket.Chat 向导：等待邮件确认安全码](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-3.webp)

*图 3：在线注册「等待确认」*

**离线路径**（内网或 Cloud 邮件不畅时）：本地生成 Token A，到 Cloud 换 Token B，再贴回本地。

![Rocket.Chat 离线注册：复制本地 Token](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-4.webp)
...
![Rocket.Chat Cloud 登录页：需先 Create account](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-5.webp)

*图 5：Cloud Login——新用户点 Create account*

登录成功后若走 magic-link，会看到已发信提示：

![Cloud 提示已发送登录链接](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-6.webp)
...
![Cloud：粘贴本地 Token 后 Continue](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-7.webp)

*图 7：Register Offline Workspace Step 1*

**Step 2**：复制 Cloud 生成的 Token B（**务必立刻复制**，离开后无法再看）：

![Cloud：复制 response code](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-8.webp)

*图 8：Step 2——Copy generated code（只显示一次）*

回到本地向导，粘贴 Token B，点 **完成注册**：

![本地粘贴 Cloud Token 并完成注册](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-9.webp)

*图 9：本地「完成注册」*

若按钮一直灰色：清空后完整重贴、点输入框外失焦、换浏览器；Token 极长，粘贴不全最常见。敏感操作可能要求再输一次管理员密码：

![敏感操作再次验证密码](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-10.webp)
...
![Rocket.Chat Home 首页入门建议](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-11.webp)
...
![管理面板：用户列表](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-12.webp)
...
![创建频道对话框](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-13.webp)
...
![目录：频道列表与 general](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-14.webp)
...
![Google Play：Rocket.Chat 移动应用](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-15.webp)
...
![管理：布局设置](https://imgs.xuanyuan.cloud/docker/blog/rocketchat-16.webp)
