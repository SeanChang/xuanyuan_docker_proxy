...
![不用安装 Office：Docker 部署 WPS，浏览器即可编辑 Word、Excel、PPT](https://imgs.xuanyuan.cloud/docker/blog/wps-office.png)
...
![浏览器中的 WPS Office 中文主界面](https://imgs.xuanyuan.cloud/docker/blog/wps-office-4.png)
...
![HTTP 基本认证登录框](https://imgs.xuanyuan.cloud/docker/blog/wps-office-1.png)
...
![HTTPS 强制要求报错](https://imgs.xuanyuan.cloud/docker/blog/wps-office-2.png)

*图 3：HTTP 访问时提示 "This application requires a secure connection (HTTPS)"*

**处理**：改用 `https://服务器IP:3001` 访问。HTTPS 登录框如下：

![HTTPS 基本认证登录框](https://imgs.xuanyuan.cloud/docker/blog/wps-office-3.png)
...
![打开文件对话框](https://imgs.xuanyuan.cloud/docker/blog/wps-office-5.png)
...
![新建文档界面](https://imgs.xuanyuan.cloud/docker/blog/wps-office-6.png)
...
![WPS Writer 新建文档模板](https://imgs.xuanyuan.cloud/docker/blog/wps-office-7.png)
...
![桌面上的已上传文档](https://imgs.xuanyuan.cloud/docker/blog/wps-office-8.png)
...
![编辑 Word 文档](https://imgs.xuanyuan.cloud/docker/blog/wps-office-9.png)
